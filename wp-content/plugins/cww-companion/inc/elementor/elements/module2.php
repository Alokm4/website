...
class Xews_Lite_Module2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Module 2', 'newzz-elements');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_title_control', [
                'label' => esc_html__('Section Title', 'newzz-elements'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'           => esc_html__( 'Popular News', 'newzz-elements' ),
            ]
        );
        ...
        $this->add_control(
            'section_title_url',
            [
                'label'             => esc_html__( 'Section Title URL', 'newzz-elements' ),
        ...
        $this->add_control(
            ...
            [
                'label'             => esc_html__( 'Layout', 'newzz-elements' ),
                'type'              => Controls_Manager::SELECT,
                'default'           => 'layout-1',
                'options'           => [
                    'layout-1' => esc_html__('Layout One','newzz-elements'),
                    'layout-2' => esc_html__('Laoyut Two','newzz-elements'),
                    'layout-3' => esc_html__('Layout Three','newzz-elements'),
                    'layout-4' => esc_html__('Layout Four','newzz-elements'),
                ]
        ...
        $this->start_controls_section(
            'header', [
                'label' => esc_html__('Module Options', 'newzz-elements'),
            ]
        );
         ...
         $this->add_control(
            'post_meta',
            [
                'label'             => esc_html__( 'Post Meta', 'newzz-elements' ),
                'type'              => Controls_Manager::SWITCHER,
                'default'           => 'yes',
                'label_on'          => esc_html__( 'Yes', 'newzz-elements' ),
                'label_off'         => esc_html__( 'No', 'newzz-elements' ),
                'return_value'      => 'yes',
            ]
        );
        ...
        $this->add_control(
            'post_author',
            [
                'label'             => esc_html__( 'Post Author', 'newzz-elements' ),
                'type'              => Controls_Manager::SWITCHER,
                'default'           => 'yes',
                'label_on'          => esc_html__( 'Yes', 'newzz-elements' ),
                'label_off'         => esc_html__( 'No', 'newzz-elements' ),
        ...
        $this->add_control(
            'post_category',
            [
                'label'             => esc_html__( 'Post Category', 'newzz-elements' ),
                'type'              => Controls_Manager::SWITCHER,
                'default'           => 'yes',
                'label_on'          => esc_html__( 'Yes', 'newzz-elements' ),
                'label_off'         => esc_html__( 'No', 'newzz-elements' ),
        ...
        $this->add_control(
            'post_date',
            [
                'label'             => esc_html__( 'Post Date', 'newzz-elements' ),
                'type'              => Controls_Manager::SWITCHER,
                'default'           => 'yes',
                'label_on'          => esc_html__( 'Yes', 'newzz-elements' ),
                'label_off'         => esc_html__( 'No', 'newzz-elements' ),
         ...
         $this->add_control(
            'post_excerpt',
            [
                'label'             => esc_html__( 'Post Excerpt', 'newzz-elements' ),
                'type'              => Controls_Manager::SWITCHER,
                'default'           => 'no',
                'label_on'          => esc_html__( 'Yes', 'newzz-elements' ),
                'label_off'         => esc_html__( 'No', 'newzz-elements' ),
        ...
        $this->add_control(
            'read_more',
            [
                'label'             => esc_html__( 'Read More Button', 'newzz-elements' ),
                'type'              => Controls_Manager::SWITCHER,
                'default'           => 'no',
                'label_on'          => esc_html__( 'Yes', 'newzz-elements' ),
                'label_off'         => esc_html__( 'No', 'newzz-elements' ),
        ...
        $this->add_control(
            'excerpt_length',
            [
                'label'             => esc_html__( 'Excerpt Length', 'newzz-elements' ),
        ...
        $this->add_control(
            'posts_columns',
            [
                'label'             => esc_html__( 'Post Columns', 'newzz-elements' ),
                'type'              => Controls_Manager::SELECT,
                'default'           => 'col-3',
                'options'           => [
                    'col-1' => esc_html__('1 Columns','newzz-elements'),
                    'col-2' => esc_html__('2 Columns','newzz-elements'),
                    'col-3' => esc_html__('3 Columns','newzz-elements'),
                    'col-4' => esc_html__('4 Columns','newzz-elements'),
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default'           => 'layout-1',
                'options'           => [
                    'layout-1' => esc_html__('Layout 1','newzz-elements'),
                    'layout-2' => esc_html__('Layout 2','newzz-elements'),
                ]
        ...
        $this->add_control(
            'post_counter',
            [
                'label'             => esc_html__( 'Display Post Counter', 'newzz-elements' ),
                'type'              => Controls_Manager::SWITCHER,
                'default'           => false,
                'label_on'          => esc_html__( 'Yes', 'newzz-elements' ),
                'label_off'         => esc_html__( 'No', 'newzz-elements' ),
        ...
        $this->add_group_control(
            ...
            [
                'name'              => 'image_size',
                'label'             => esc_html__( 'Image Size', 'newzz-elements' ),
        ...
        $this->start_controls_section(
            'section_post_query',
            [
                'label'             => esc_html__( 'Query', 'newzz-elements' ),
            ]
        );
        ...
        $this->add_group_control(
            ...
            'name' => 'posts',
            'label' => esc_html__( 'Posts', 'newzz-elements' ),
                ]
        );
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label'             => esc_html__( 'No. Of Posts To Display', 'newzz-elements' ),
                'type'              => Controls_Manager::NUMBER,
                'default'           => 3,
                'min'               => 1,
                'max'               => 10,
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'label' => esc_html__('Typography', 'newzz-elements'),
        ...
        $this->add_control(
            'title_text_color', [
                'label'     => __('Text Color', 'newzz-elements'),
        ...
        $this->add_control(
            'title_border_color', [
                'label'     => __('Border Color', 'newzz-elements'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_3,
        ...
        $this->start_controls_section(
                'section_header_style', [
                    'label' => esc_html__('Post Title', 'newzz-elements'),
                    'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_control(
            'header_text_color_hover', [
                'label'     => __('Text Color:Hover', 'newzz-elements'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_3,
        ...
        $this->start_controls_section(
                'content_style', [
                    'label' => esc_html__('Post Contents', 'newzz-elements'),
                    'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->start_controls_section(
            'post_counter_style', [
                'label' => esc_html__('Post Counter', 'newzz-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'         => [
                    'post_counter'     => 'yes',
                ],
        ...
        $this->add_control(
            'counter_bgcolor', [
                'label'     => __('Background Color', 'newzz-elements'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_3,
    ...
    public function render() {
        ...
        if ( ! empty( $settings['section_title_url']['url'] ) ) {
			$this->add_render_attribute( 'url', 'href', $settings['section_title_url']['url'] );
        ...
        $this->add_render_attribute('code-wrapp', 'class', 'code-wrapp module2 cww-flex '. $posts_layout);
