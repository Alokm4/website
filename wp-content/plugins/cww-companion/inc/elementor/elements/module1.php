...
class Xews_Lite_Module1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Module 1', 'newzz-elements');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'           => 'col-3',
                'options'           => [
                    'col-1' => esc_html__('1 Column','newzz-elements'),
        ...
        $this->add_control(
            'text_align',
            [
                'label'             => esc_html__( 'Text Align', 'newzz-elements' ),
                'type'              => Controls_Manager::SELECT,
                'default'           => 'left',
                'options'           => [
                    'left'      => esc_html__('Left','newzz-elements'),
                    'center'    => esc_html__('Center','newzz-elements'),
                ],
                'selectors' => [
    ...
    public function render() {
        ...
        $this->add_render_attribute('code-wrapp', 'class', 'code-wrapp module1 cww-flex '. $posts_layout);
